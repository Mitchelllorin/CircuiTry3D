...
const CONFIG: CategoryConfig[] = [
  ...
  },
  {
    ...
    controls: [
      ...
      { kind: "slider", key: "atmosphereDensity", label: "Dust motes", min: 0, max: 100, step: 1, format: pct, hint: "Specks drifting in the air of the 3D scene. Off by default — turn it up for haze" },
