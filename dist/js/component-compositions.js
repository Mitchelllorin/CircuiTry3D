...
(function (global) {
  ...
  const MATERIAL_LIBRARY = {
    ...
    // Wire insulation jacket materials (meltingPoint = thermal degradation onset, not true melt)
    pvc_jacket_80:      { name: "PVC Insulation Jacket (80 °C)",          density: 1.35,  thermalConductivity: 0.17,  specificHeat: 1050, meltingPoint: 80,   electricalResistivity: 1e14,     thermalExpansion: 80  },
    xlpe_jacket_125:    { name: "XLPE Insulation Jacket (125 °C)",         density: 0.95,  thermalConductivity: 0.25,  specificHeat: 1900, meltingPoint: 125,  electricalResistivity: 1e15,     thermalExpansion: 150 },
    silicone_jacket_200:{ name: "Silicone Rubber Jacket (200 °C)",         density: 1.20,  thermalConductivity: 0.25,  specificHeat: 1460, meltingPoint: 200,  electricalResistivity: 1e14,     thermalExpansion: 300 },
    ptfe_jacket_260:    { name: "PTFE Jacket (260 °C)",                    density: 2.20,  thermalConductivity: 0.25,  specificHeat: 1000, meltingPoint: 260,  electricalResistivity: 1e18,     thermalExpansion: 135 },
    epdm_jacket_150:    { name: "EPDM Rubber Jacket (150 °C)",             density: 0.86,  thermalConductivity: 0.25,  specificHeat: 2000, meltingPoint: 150,  electricalResistivity: 1e14,     thermalExpansion: 200 },
    neoprene_jacket_90: { name: "Neoprene Jacket (90 °C)",                 density: 1.25,  thermalConductivity: 0.19,  specificHeat: 2090, meltingPoint: 90,   electricalResistivity: 1e13,     thermalExpansion: 190 },
  };
  ...
  const COMPONENT_COMPOSITIONS = [
    ...
    },
    {
      ...
      constructionNote: "Stranded annealed-copper conductor with PVC insulation jacket (80 °C class); rated per NEC Table 310.16 ampacity. Represents the default 14 AWG chassis wire — select a specific wire spec from the Wire Guide for accurate insulation-class thresholds.",
      subComponents: [
      ...
      internalLayers: [
        { materialKey: "copper",       label: "Cu Conductor", type: "cylinder", position: [0,0,0], rotation: [0,0,1.5708], scale: [0.07,1.00,0.07], color: "#B87333", opacity: 0.95 },
        { materialKey: "pvc_jacket_80", label: "PVC Jacket",  type: "cylinder", position: [0,0,0], rotation: [0,0,1.5708], scale: [0.14,1.00,0.14], color: "#888800", opacity: 0.40 },
      ],
    },
  ];
